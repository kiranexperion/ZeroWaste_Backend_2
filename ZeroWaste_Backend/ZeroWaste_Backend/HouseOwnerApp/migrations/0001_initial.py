...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('remarks', models.TextField(default='NA', null=True)),
                ('status', models.CharField(default='Pending', max_length=200)),
                ('registrationdate', models.DateField()),
                ('complaints_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HouseOwnerApp.complaints')),
                ('houseowner_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HouseOwnerApp.houseowner')),
            ],
        ),
        migrations.AddField(
            ...
            name='houseowner_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HouseOwnerApp.houseowner'),
        ),
        migrations.AddField(
            model_name='complaints',
            name='wardno',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CorporationApp.wards'),
        ),
        migrations.CreateModel(
            name='bookingstatus',
            fields=[
